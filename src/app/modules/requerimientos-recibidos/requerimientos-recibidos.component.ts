...
@Component({
  selector: 'app-requerimientos-recibidos',
  templateUrl: './requerimientos-recibidos.component.html',
  styleUrls: ['./requerimientos-recibidos.component.css']
})
export class RequerimientosRecibidosComponent implements OnInit {
